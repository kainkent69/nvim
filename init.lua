...
local path = '/home/lowe/.config/nvim'
...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      -- setup the format
      vim.keymap.set('n', '<leader>sfe', vim.lsp.buf.format, {
        desc = 'Format code',
      })
    end,
