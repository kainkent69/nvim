...
require('lazy').setup({
  ...
  require 'custom.plugins.multi-line',
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- Allows extra capabilities provided by nvim-cmpinit
    ...
    config = function()
      ...
      local servers = {
        ...
        emmet_language_server = {
          filetypes = { 'css', 'ruby', 'html', 'javascript', 'javascriptreact', 'less', 'sass', 'scss', 'pug', 'typescriptreact', 'svelte' },
